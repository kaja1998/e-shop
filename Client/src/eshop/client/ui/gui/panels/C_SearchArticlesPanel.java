...
public class C_SearchArticlesPanel extends JPanel {
    ...
    // Über dieses Interface übermittelt das C_SearchArticlesPanel
    // Suchergebnisse an einen Empfänger. Hier das C_EmployeeFrontEnd,
    ...
    public C_SearchArticlesPanel(ShopInterface shop, C_SearchArticlesPanel.SearchResultListener searchResultListener) {
        eshop = shop;
