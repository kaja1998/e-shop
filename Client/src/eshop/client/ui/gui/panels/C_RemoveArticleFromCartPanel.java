...
public class C_RemoveArticleFromCartPanel extends JPanel{
    ...
    public C_RemoveArticleFromCartPanel(ShopInterface shop, User user, C_RemoveArticleFromCartPanel.RemoveCartItemFromCartListener removeCartItemFromCartListener) {
        this.eshop = shop;
        this.user = user;
